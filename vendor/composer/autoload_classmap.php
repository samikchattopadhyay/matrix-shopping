...
return array(
    'AddressController' => $baseDir . '/admin/controllers/AddressController.php',
    'AddressModel' => $baseDir . '/admin/models/AddressModel.php',
    'AuthController' => $baseDir . '/admin/controllers/AuthController.php',
    'AuthMiddleware' => $baseDir . '/admin/middlewares/AuthMiddleware.php',
    'CategoryController' => $baseDir . '/admin/controllers/CategoryController.php',
    'CategoryModel' => $baseDir . '/admin/models/CategoryModel.php',
    'CityController' => $baseDir . '/admin/controllers/CityController.php',
    'CityModel' => $baseDir . '/admin/models/CityModel.php',
    'DashboardController' => $baseDir . '/admin/controllers/DashboardController.php',
    'Database' => $baseDir . '/lib/Database.php',
    'ErrorController' => $baseDir . '/admin/controllers/ErrorController.php',
    'MatrixController' => $baseDir . '/admin/controllers/MatrixController.php',
    ...
    'StateModel' => $baseDir . '/admin/models/StateModel.php',
    'SupplierController' => $baseDir . '/admin/controllers/SupplierController.php',
    'SupplierModel' => $baseDir . '/admin/models/SupplierModel.php',
    ...
    'UserController' => $baseDir . '/admin/controllers/UserController.php',
    'UserModel' => $baseDir . '/admin/models/UserModel.php',
    'Zebra_Mptt' => $vendorDir . '/stefangabos/zebra_mptt/Zebra_Mptt.php',
);
