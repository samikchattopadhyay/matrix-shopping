...
<!-- ============================================================== -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Address Book - {{ @$action }}</h4>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <form id="saveAddress" action="{{ url('saveAddress') }}" method="post" class="form-horizontal">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control required" id="locality" name="locality" value="{{ @$address->locality }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="pin" class="col-sm-3 control-label col-form-label">PIN</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control required" id="pin" name="pin" value="{{ @$address->pin }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control required" id="mobile" name="mobile" value="{{ @$address->mobile }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
