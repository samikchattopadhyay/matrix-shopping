...
<!-- ============================================================== -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <form id="saveSupplierForm" action="{{ url('saveSupplier') }}" method="post" class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-1 text-right">
                                            <a role="button" class="btn btn-primary" title="Add new supplier address" href="{{ url('addAddress') }}"><i class="mdi mdi-library-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
