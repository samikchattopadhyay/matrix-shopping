                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                        		<?php if (isset($categoryTree) && count($categoryTree)): ?>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ url('listCategories', [ 'pid' => '' ]) }}">Root</a></li>
                                        <?php foreach($categoryTree as $cId => $cat): ?>
                                        	<li class="breadcrumb-item active" aria-current="page">
                                        		<?php if ($cId < (count($categoryTree) - 1) && ($cat['rgt'] - $cat['lft']) > 1): ?>
                                        			<a href="{{ url('listCategories', [ 'pid' => $cat['id'] ]) }}"><?php echo $cat['name'] ?></a>
                                        		<?php else: ?>
                                        			<?php echo $cat['name'] ?>
                                        		<?php endif; ?>
                                        	</li>
                                        ...
                                        <tbody>
                                        	<?php if (isset($categories) && count($categories)): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<a role="button" class="btn btn-outline-primary btn-sm" href="{{ url('addCategory', [ 'pid' => $category->id ]) }}" title="Add sub category"><i class="mdi mdi-folder-plus"></i></a>
                                                    	<a role="button" class="btn btn-outline-primary btn-sm" href="{{ url('editCategory', [ 'id' => $category->id ]) }}" title="Edit"><i class="mdi mdi-lead-pencil"></i></a>
