...
@section('customcss')
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo assets('libs/jquery-minicolors/jquery.minicolors.css') ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo assets('libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo assets('libs/quill/dist/quill.snow.css') ?>">
@endsection


@section('thispagejs')
    	<script src="<?php echo assets('libs/inputmask/dist/min/jquery.inputmask.bundle.min.js') ?>"></script>
        <script src="<?php echo assets('dist/js/pages/mask/mask.init.js') ?>"></script>
        ...
        <script src="<?php echo assets('libs/jquery-asColor/dist/jquery-asColor.min.js') ?>"></script>
        <script src="<?php echo assets('libs/jquery-asGradient/dist/jquery-asGradient.js') ?>"></script>
        <script src="<?php echo assets('libs/jquery-asColorPicker/dist/jquery-asColorPicker.min.js') ?>"></script>
        <script src="<?php echo assets('libs/jquery-minicolors/jquery.minicolors.min.js') ?>"></script>
        <script src="<?php echo assets('libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') ?>"></script>
        <script src="<?php echo assets('libs/quill/dist/quill.min.js') ?>"></script>
        <script>
            //***********************************//
            // For select 2
            //***********************************//
