...
@section('customcss')
    	<link href="<?php echo assets('libs/jquery-steps/jquery.steps.css')?>" rel="stylesheet">
        <link href="<?php echo assets('libs/jquery-steps/steps.css')?>" rel="stylesheet">
...
@section('thispagejs')
 ...
 <!-- this page js -->
    <script src="<?php echo assets('libs/jquery-steps/build/jquery.steps.min.js')?>"></script>
