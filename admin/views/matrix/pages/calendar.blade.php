...
@section('customcss')
<link href="<?php echo assets('libs/fullcalendar/dist/fullcalendar.min.css') ?>" rel="stylesheet" />
    <link href="<?php echo assets('extra-libs/calendar/calendar.css') ?>" rel="stylesheet" />
@endsection



@section('thispagejs')
<script src="<?php echo assets('libs/moment/min/moment.min.js') ?>"></script>
    <script src="<?php echo assets('libs/fullcalendar/dist/fullcalendar.min.js') ?>"></script>
